...
checkpoint = torch.load('checkpoints/resnet_50_deconv.pth.tar')
...
keypoint_head_list = [
    ...
    "deconv_layers.1.weight",
    "deconv_layers.1.bias",
    "deconv_layers.1.running_mean",
    "deconv_layers.1.running_var",
    "deconv_layers.1.num_batches_tracked",
    "deconv_layers.3.weight",
    "deconv_layers.4.weight",
    "deconv_layers.4.bias",
...
for k,v in checkpoint.items():
    if k in backbone_list:
        new_checkpoint[f'backbone.{k}'] = v
    elif k in keypoint_head_list:
        new_checkpoint[f'keypoint_head.{k}'] = v

torch.save(new_checkpoint,'checkpoints/resnet_50_deconv_add_prefix.pth.tar')
